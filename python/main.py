...
import keyboard  # novo import

# Valor limite para decidir se deve pressionar a tecla
THRESHOLD = 1000

def controlar_teclado(axis, value):
    """
    Mapeia os eixos e valores recebidos para as teclas W A S D.
    """

    if axis == 0:
        # Direção esquerda/direita (volante)
        if value < 2:
            keyboard.press('a')
            keyboard.release('d')
        elif value > 2:
